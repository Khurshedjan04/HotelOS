...
const COLUMNS: { status: OrderStatus; label: string; icon: string }[] = [
  ...
  { status: "OutForDelivery", label: "Out for Delivery", icon: "🛎️" },
...
export default function KitchenPage() {
  ...
  // SignalR: subscribe to kitchen channel for real-time order updates
  useEffect(() => {
    ...
    const setup = async () => {
      try {
        ...
        // Listen for order events and reload
        ...
        // SignalR not available — silently skip real-time updates
      }
    };
