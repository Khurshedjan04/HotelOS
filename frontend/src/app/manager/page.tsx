  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        <StatCard label="Available Rooms" value={available} icon="✅" color="green" />
        <StatCard label="Active Stays" value={activeRooms} icon="🏨" color="blue" />
        <StatCard label="Cleaning Jobs" value={cleaning.length} icon="🧹" color="gold" />
        <StatCard label="Open Tickets" value={openTickets} icon="🔧" color="red" />
      </div>
